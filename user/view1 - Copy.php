		...
		<div class="col-md-4 products-left">
				<div class="categories">
					...
					<u>	<li><a href="view1.php?category=comedy"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Comedy</a></li><u>
						<li><a href="view1.php?category=drama <?php $flag=31;?>"  target="myiframe"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Drama</a></li>
						<li><a href="view1.php?category=fantasy" target="myiframe"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Fantasy</a></li>
						<li><a href="view1.php?category=horror" target="myiframe"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Horror</a></li>
						<li><a href="view1.php?category=mythology" target="myiframe"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Mythology</a></li>
						<li><a href="view1.php?category=romance" target="myiframe"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Romance</a> </li>
						<li><a href="view1.php?category=satire" target="myiframe"> <i class="fa fa-arrow-right" aria-hidden="true"></i>Satire</a> </li>
						<li><a href="view1.php?category=sifi" target="myiframe"> <i class="fa fa-arrow-right" aria-hidden="true"></i>SiFi</a></li>
					</ul>
...
<link href="css/table/css/style.css" rel="stylesheet">
		...
		<?php 
			...
			include_once("dbconnect.php");
				...
				if ($result->num_rows > 0) 
				{
					...
					{
						$img=$row['img_path'];
						echo "<div class='plan' id='most-popular' style='width:300px'>";
						echo "<h3>".$row["book_name"]."<span> <img src='$img' height='80px' width='80px'> </span> </h3>";
						
							echo "<ul>";
								echo "<li><b>Name : </b>".$row["book_name"]."</li>";
