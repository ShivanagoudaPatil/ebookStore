...
session_start();
if(isset($_POST['pack'])) {
    if($_POST['pack'] == 499.00) {
        $amt=499.00;
    } elseif($_POST['pack'] == 999.00) {
        $amt=999.00;
    }
}
?>
<html>
    ...
    <body>
        ...
        <div id="main">
            <center><h1>Complete Payments via Credit/Debit Card</h1></center>
            <form action="DoDirectPayment.php" method="POST">
                <div id="container">
                    <h2>Pay with my Credit or Debit card</h2>
                    <hr/>
                    ...
                    <table style="width:100%">
                        ...
                        <tr>
							...
							<?php } elseif($amt==999) { ?>
								<input type="hidden" name="pcheck" value="999">	
							<?php } ?>
                        </tr>
                    </table>
                            ...
                            <td>
                                <div id="date-div">
                                    <select id="state" name="state">
                                        ...
                                        <option value="MH">UK</option>
                                        <option value="MP">MP</option>
                                        <option value="PR">PR</option>
                                        <option value="PW">PW</option>
                                        <option value="VI">US</option>
                                    </select>
            ...
            <img id="paypal_logo" style="float:right; margin: -30px -42px 0 0;" src="img/secure-paypal-logo.jpg">
        </div>
