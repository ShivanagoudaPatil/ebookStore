...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>eBook Store</title>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/your_style.css">
		<link rel="stylesheet" type="text/css" media="screen" href="<?php echo ASSETS_URL; ?>/css/tooth_chart.css">
	...
	<body <?php echo implode(' ', array_map(function($prop, $value) {
			return $prop.'="'.$value.'"';
		}, array_keys($page_body_prop), $page_body_prop)) ;?> class="smart-style-1">
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <img src="logo.png" alt="eBook Store"> </span>
					...
					<div class="pull-right">
						...
						<!-- logout button -->
                        <div id="logout#" class="btn-header transparent pull-right" style="margin-left: 20px ">
